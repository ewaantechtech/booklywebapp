...
<body dir="rtl" style="direction: rtl; text-align: right;">
    <div style="direction: rtl; text-align: right;">
        <h2 style="text-align: right;">تم تسجيل مزود خدمة جديد.</h2>

        <p style="text-align: right;">عزيزتي Admin،</p>

        <p style="text-align: right;">تم تسجيل مزود خدمة جديد في النظام. يرجى التحقق من التسجيل والموافقة عليه.</p>
        ...
        <div class="section" style="direction: rtl; text-align: right;">
          ...
          {{--  <div class="info-line" style="text-align: right;">
            ...
            <div class="info-line" style="text-align: right;">
                ...
                <span class="value">{{ $account->phone_number }}</span>
            </div>
            @endif       
        </div>  
